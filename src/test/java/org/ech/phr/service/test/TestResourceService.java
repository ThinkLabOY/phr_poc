...
public class TestResourceService {
	...
	public void testFindOrInsertPerson() {
    	try {
			Resource resource = resourceService.putResourceReference("37966661234", "http://www.politsei.ee/", "ORG1", FhirUtil.OID_PHR, FhirUtil.TYPE_PATIENT, FhirUtil.OID_PHR, "37966661234", "http://www.politsei.ee/");
			Assert.assertNotNull("Person should not be null!", resource);
			List<Resource> resources = resourceService.getResourceReferences("37966661234", "http://www.politsei.ee/", "ORG1", FhirUtil.OID_PHR, FhirUtil.TYPE_PATIENT, FhirUtil.OID_PHR);
